...
read_fasta_file <- function(filename) {
    .Call('_ldmap_read_fasta_file', PACKAGE = 'ldmap', filename)
}
...
write_plink_bed_f <- function(x, file_name, append = FALSE) {
    invisible(.Call('_ldmap_write_plink_bed_f', PACKAGE = 'ldmap', x, file_name, append))
}

read_plink_bed_idx <- function(file_name, id, N) {
    .Call('_ldmap_read_plink_bed_idx', PACKAGE = 'ldmap', file_name, id, N)
}
